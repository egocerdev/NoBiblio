...
function SocialPost({ post, profile, profiles, isFollowing, comments, toggleFollow, loadComments, addComment, quotePost, reportTarget, rateAuthor }) {
